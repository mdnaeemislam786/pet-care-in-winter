      ...
      <div className="card w-full max-w-2xl bg-base-100/90 backdrop-blur-md shadow-2xl border border-cyan-500/20">
        <div className="card-body bg-gradient-to-tr hover:bg-gradient-to-br  from-blue-200 via-blue-300 to-cyan-300 delay-150 duration-300 p-8">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-100">Create your account for premium pet care services</p>
          </div>
          ...
          <form className="space-y-3" onSubmit={handleSubmit}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="form-control">
                <label className="label">
                  <span className="label-text text-cyan-100 font-medium">First Name</span>
                </label>
                <input
                  type="text"
                  name="firstName"
              ...
              <div className="form-control">
                <label className="label">
                  <span className="label-text text-cyan-100 font-medium">Last Name</span>
                </label>
                <input
                  type="text"
                  name="lastName"
            ...
            <div className="form-control">
              <label className="label">
                <span className="label-text text-cyan-100 font-medium">Email Address</span>
              </label>
              <input
                type="email"
                name="email"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="form-control">
                <label className="label">
                  <span className="label-text text-cyan-100 font-medium">Password</span>
                </label>
              ...
              <div className="form-control">
                <label className="label">
                  <span className="label-text text-cyan-100 font-medium">Confirm Password</span>
                </label>
                <div className="relative">
                  <input
            ...
            <div className="form-control">
              <label className="label cursor-pointer justify-start gap-3">
                ...
                <span className="label-text flex flex-wrap text-cyan-100">
                  I agree to the <a href="#" className="text-cyan-300 hover:text-cyan-100 underline">Terms & Conditions</a>  and <a href="#" className="text-cyan-300 hover:text-cyan-100 underline">Privacy Policy</a>
                </span>
              </label>
            </div>
            ...
            <div className="text-center">
              <span className="text-sm text-cyan-100">
                ...
                <Link to="/auth/login" className="text-cyan-500 hover:text-blue-300 font-medium transition-colors duration-300 hover:underline">
                  Sign in
                </Link>
              </span>
            </div>
