...
import bgimage4 from "../../public/images/img4.jpg";
import bgimage5 from "../../public/images/img5.jpg";
import bgimage6 from "../../public/images/img6.jpg";
  ...
  const winterPetCareTips = [
    {
      ...
      description:
        "Keep your pet's coat well-groomed during winter. Regular brushing helps maintain natural oils that provide insulation against the cold.",
      bgImage: bgimage1,
      tips: [
        "Brush regularly",
        "Don't shave completely",
        "Check for dry skin",
    ...
    },
    {
      ...
      title: "Indoor Warmth",
      description:
        "Create a cozy warm space indoors away from drafts. Pets need extra warmth during cold months to maintain body temperature.",
      bgImage: bgimage2,
      tips: [
        "Warm bedding",
        "Avoid cold floors",
    ...
    },
    {
      ...
      description:
        "Protect paws from ice, snow, and harmful salts. Winter chemicals can cause burns and irritation to sensitive paw pads.",
      bgImage: bgimage3,
      tips: [
    ...
    },
    {
      ...
      description:
        "Pets can get dehydrated in winter too. Ensure fresh water is always available and check outdoor water bowls don't freeze.",
      bgImage: bgimage4,
      tips: [
        "Fresh water always",
        "Check bowl temperature",
        "Monitor intake",
        "Wet food addition",
      ],
      duration: "Constant",
    },
    {
      ...
      title: "Exercise & Play",
      description:
        "Maintain regular exercise but be mindful of temperature. Shorter, more frequent walks are better in extreme cold conditions.",
      bgImage: bgimage5,
      tips: [
        "Shorter walks",
        "Indoor play",
        "Watch for shivering",
        "Avoid early/late walks",
      ],
    ...
    },
    {
      ...
      description:
        "Adjust food portions based on activity level. Indoor pets may need less food while active pets might need more calories for warmth.",
      bgImage: bgimage6,
      tips: [
        "Monitor weight",
        "Adjust portions",
  ...
  return (
    <div className="w-full max-w-7xl mx-auto px-4 py-16">
      ...
      <div className="relative">
        ...
        <div className="swiper-button-prev absolute left-4 top-1/2 transform -translate-y-1/2 z-10 w-14 h-14   flex items-center justify-center  hover:scale-110 transition-all duration-300 group"></div>

        <div className="swiper-button-next absolute right-4 top-1/2 transform -translate-y-1/2 z-10 w-14 h-14  flex items-center justify-center hover:scale-110 transition-all duration-300 group"></div>
      </div>
    </div>
  );
};
